...
import {
    ...
    getHvcCodec,
    getAv1Codec
} from './codec-helpers.js'; // relevant specs for this parser:
    ...
    tracks.forEach(function(track) {
        ...
        if (/V_MPEG4\/ISO\/AVC/.test(decodedTrack.rawCodec)) {
            ...
            if (decodedTrack.codecPrivate) {
                ...
                var matrixCoefficients = findEbml(track, [0xE0, [0x55, 0xB0],
                    [0x55, 0xB1]
                ])[0] || [];
                var videoFullRangeFlag = findEbml(track, [0xE0, [0x55, 0xB0],
                    [0x55, 0xB9]
                ])[0] || [];
                var transferCharacteristics = findEbml(track, [0xE0, [0x55, 0xB0],
                    [0x55, 0xBA]
                ])[0] || [];
                var colourPrimaries = findEbml(track, [0xE0, [0x55, 0xB0],
                    [0x55, 0xBB]
